...
CREATE TABLE "USABLE_ITEMS" (
	...
	`DESCRIPTION`	TEXT,
	`EFFECT_TYPE`	TEXT,
	`DIECE_NUMBER`	INTEGER,
	`DIECE_VALUE`	INTEGER,
	`STATIC_VALUE`	INTEGER,
	`TARGETS_NUMBER`	INTEGER,
	`TARGETS_TYPE`	INTEGER,
	`RANGE`	INTEGER,
	`EFFECT_SHAPE`	INTEGER,
	`EFFECT_SHAPE_SIZE`	INTEGER,
	`ICON_NAME`	TEXT,
	`CAN_BE_SHORTCUT`	INTEGER NOT NULL DEFAULT 0
);
INSERT INTO `USABLE_ITEMS` (ID,NAME,DESCRIPTION,EFFECT_TYPE,DIECE_NUMBER,DIECE_VALUE,STATIC_VALUE,TARGETS_NUMBER,TARGETS_TYPE,RANGE,EFFECT_SHAPE,EFFECT_SHAPE_SIZE,ICON_NAME,CAN_BE_SHORTCUT) VALUES (1,'Healing Potion','Light healing potion. It is one of most common magic items.','1',2,4,2,1,1,NULL,NULL,NULL,'HealingPotion',0);
CREATE TABLE "TARGET_TYPES" (
	`ID`	INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT UNIQUE,
	`NAME`	TEXT NOT NULL UNIQUE
);
INSERT INTO `TARGET_TYPES` (ID,NAME) VALUES (1,'SELF'),
 (2,'CREATURE'),
 (3,'ALLY'),
 (4,'ENEMY'),
 (5,'FIELD');
...
INSERT INTO `EFFECT_TYPES` (ID,NAME) VALUES (1,'POSITIVE_ENERGY');
